 ...
 *
 */
public class RepositoryCacheML {
	...
	RepositoryCacheML(String gitDir) {
		this.GitDir=gitDir;
	}
	
	RepositoryCacheML(Repository repository) {
		this.db=repository;
	}

	public synchronized Repository createRepository(final File gitDir)
			throws IOException {
